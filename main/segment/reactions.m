...
A_g_ij = [S_ij(1),S_ij(2),S_ij(3); (T*m*g*cos(pi-acos(([0,0,1]*VG_ij(2,:))/((mag(VG_ij))^2))))*cos(falpha(VG_ij)),(T*m*g*cos(pi-acos(([0,0,1]*VG_ij(2,:))/((mag(VG_ij))^2))))*cos(fbeta(VG_ij)),(T*m*g*cos(pi-acos(([0,0,1]*VG_ij(2,:))/((mag(VG_ij))^2))))*cos(fgamma(VG_ij))];
...
A_f_ij = [R_ij(1),R_ij(2),R_ij(3); -((F(S_ij(1),S_ij(2))+F(R_ij(1),R_ij(2)))/2) * (A_G_ij+mag(A_n_ij))^2 * cos(falpha(O_ij)),-((F(S_ij(1),S_ij(2))+F(R_ij(1),R_ij(2)))/2) * (A_G_ij+mag(A_n_ij))^2 * cos(fbeta(O_ij)),-((F(S_ij(1),S_ij(2))+F(R_ij(1),R_ij(2)))/2) * (A_G_ij+mag(A_n_ij))^2 * cos(fgamma(O_ij))];
