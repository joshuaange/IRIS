function [dLdxS, dLdyS, N, vec_N, vec_PN, vec_P, vec_B, mag, S, vec_O] = III_directions(L, S, velocityHit, T, dLdx, dLdy)
...
%quiver3(vec_B(1,1),vec_B(1,2),vec_B(1,3),vec_B(2,1),vec_B(2,2),vec_B(2,3),'lineWidth',1,'Color','magenta','MaxHeadSize',0.5,'DisplayName','vec_{B}');
%quiver3(vec_P(1,1),vec_P(1,2),vec_P(1,3),vec_P(2,1),vec_P(2,2),vec_P(2,3),'lineWidth',1,'Color','red','MaxHeadSize',0.5,'DisplayName','vec_{P}');
