for iit = 1:iitMax
    if isempty(b{iit}) == 0
        ...
        quiver3(b{iit}.quatV_air(1,1),b{iit}.quatV_air(1,2),b{iit}.quatV_air(1,3),b{iit}.quatV_air(2,1),b{iit}.quatV_air(2,2),b{iit}.quatV_air(2,3),'lineWidth',0.5,'Color','white','MaxHeadSize',0.1,'DisplayName','quatV_air','LineStyle','--');
    end;
end;