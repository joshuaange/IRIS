for iit = 1:iitMax
    for jit = 1:jitMax
        if isempty(s{iit,jit}) == 0
            ...
            %quiver3(s{iit,jit}.quatV_next(1,1),s{iit,jit}.quatV_next(1,2),s{iit,jit}.quatV_next(1,3),s{iit,jit}.quatV_next(2,1),s{iit,jit}.quatV_next(2,2),s{iit,jit}.quatV_next(2,3),'lineWidth',3,'Color','white','MaxHeadSize',0.5,'DisplayName','quatV_next','LineStyle','-');
        end;
    end;
end;