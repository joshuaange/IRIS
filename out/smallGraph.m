for iit = 1:iitMax
    for jit = 1:jitMax
        if isempty(s{iit,jit}) == 0
            ...
            quiver3(s{iit,jit}.quatV_next(1,1),s{iit,jit}.quatV_next(1,2),s{iit,jit}.quatV_next(1,3),s{iit,jit}.quatV_next(2,1),s{iit,jit}.quatV_next(2,2),s{iit,jit}.quatV_next(2,3),'lineWidth',1,'Color','black','MaxHeadSize',0.5,'DisplayName','Quaternion_{Next}','LineStyle','-');
            ...
            quiver3(s{iit,jit}.vec_N_new(1,1),s{iit,jit}.vec_N_new(1,2),s{iit,jit}.vec_N_new(1,3),s{iit,jit}.vec_N_new(2,1),s{iit,jit}.vec_N_new(2,2),s{iit,jit}.vec_N_new(2,3),'lineWidth',1,'Color','cyan','MaxHeadSize',0.5,'DisplayName','Normal Vector (Impact)','LineStyle','--');
            ...
            quiver3(s{iit,jit}.vec_M(1,1),s{iit,jit}.vec_M(1,2),s{iit,jit}.vec_M(1,3),s{iit,jit}.vec_M(2,1),s{iit,jit}.vec_M(2,2),s{iit,jit}.vec_M(2,3),'lineWidth',1,'Color','magenta','MaxHeadSize',0.5,'DisplayName','Movement Vector');
