for iit = 1:iitMax
    for jit = 1:jitMax
        if isempty(s{iit,jit}) == 0
            ...
            quiver3(s{iit,jit}.vec_Norm(1,1),s{iit,jit}.vec_Norm(1,2),s{iit,jit}.vec_Norm(1,3),s{iit,jit}.vec_Norm(2,1),s{iit,jit}.vec_Norm(2,2),s{iit,jit}.vec_Norm(2,3),'lineWidth',1,'Color','black','MaxHeadSize',0.5,'DisplayName','vec_{Normal}','LineStyle',':');
            ...
            quiver3(s{iit,jit}.vec_B(1,1),s{iit,jit}.vec_B(1,2),s{iit,jit}.vec_B(1,3),s{iit,jit}.vec_B(2,1),s{iit,jit}.vec_B(2,2),s{iit,jit}.vec_B(2,3),'lineWidth',0.25,'Color','yellow','MaxHeadSize',0.5,'DisplayName','vec_{B}');
