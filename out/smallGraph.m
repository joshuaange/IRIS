for iit = 1:iitMax
    for jit = 1:jitMax
        if isempty(s{iit,jit}) == 0
            ...
            quiver3(s{iit,jit}.vec_VG(1,1),s{iit,jit}.vec_VG(1,2),s{iit,jit}.vec_VG(1,3),s{iit,jit}.vec_VG(2,1),s{iit,jit}.vec_VG(2,2),s{iit,jit}.vec_VG(2,3),'lineWidth',0.5,'Color','cyan','MaxHeadSize',0.5,'DisplayName','vec_{VG}','LineStyle',':');
