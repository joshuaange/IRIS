...
fprintf(fid,strcat('x_i(t) = (',string(u_i(2,1)),'*Q(z_i(t)))/g(z_i(t)) * (1-exp((-g(z_i(t))*t)/Q(z_i(t)))) + ',string(u_i(1,1)),';\n'));
fprintf(fid,strcat('y_i(t) = (',string(u_i(2,2)),'*Q(z_i(t)))/g(z_i(t)) * (1-exp((-g(z_i(t))*t)/Q(z_i(t)))) + ',string(u_i(1,2)),';\n'));
...
if parachute == 1
    ...
    fprintf(fid,'end\n');
    fprintf(fid,'x_iParachute(t) = (t_A_velX*Q_o(z_i(t)))/g(z_i(t)) * (1-exp((-g(z_i(t))*t)/Q_o(z_i(t)))) + t_A_posX;\n');
    ...
    fprintf(fid,'end\n');
    fprintf(fid,'y_iParachute(t) = (t_A_velY*Q_o(z_i(t)))/g(z_i(t)) * (1-exp((-g(z_i(t))*t)/Q_o(z_i(t)))) + t_A_posY;\n');
